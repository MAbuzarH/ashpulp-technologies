...
const Footer = () => {
  ...
  return (
    <div className="flex justify-center w-full py-12">
      <footer className="w-[95%] bg-black text-white rounded-xl px-6 py-10">
        <div className="container mx-auto">
          {/* Footer Top Section: Logo and Newsletter */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12 border-b border-gray-800 pb-10">
            {/* Logo and Tagline */}
            <div>
              <div className="mb-6">
                <Image
              ...
              <p className="text-gray-400 max-w-md mb-6">
                ...
                helping businesses grow and thrive in the digital landscape.
              </p>
            ...
            <div className="lg:ml-auto lg:max-w-md">
              ...
              <form className="flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  className="bg-gray-900 text-white px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-600 flex-grow"
                  required
                />
                <button 
                  type="submit"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <FooterLink href="/resources/guides" label="Guides" />
                <FooterLink href="/resources/case-studies" label="Case Studies" />
